return {
	-- 文件图标插件
	{
		"https://gh-proxy.com/https://github.com/nvim-tree/nvim-web-devicons",
		opts = {
			override = {
				copilot = {
					icon = "",
	...
	-- 底部状态栏插件
	{
		"https://gh-proxy.com/https://github.com/nvim-lualine/lualine.nvim",
		dependencies = {
	...
	-- 标签页插件
	{
		"https://gh-proxy.com/https://github.com/romgrk/barbar.nvim",
	...
	-- 文件树插件
	{
		"https://gh-proxy.com/https://github.com/nvim-tree/nvim-tree.lua",
		version = "*",
		lazy = false,
		dependencies = {
			"nvim-tree/nvim-web-devicons",
	...
	-- 彩虹括号
	{
		"https://gh-proxy.com/https://github.com/HiPhish/rainbow-delimiters.nvim",
	...
	-- 消息界面和弹出式菜单
	{
		"https://gh-proxy.com/https://github.com/folke/noice.nvim",
		event = "VeryLazy",
		dependencies = {
			-- if you lazy-load any plugin below, make sure to add proper `module="..."` entries
			"https://gh-proxy.com/https://github.com/MunifTanjim/nui.nvim",
			-- OPTIONAL:
	...
	-- 显示快捷键内容
	{
		"https://gh-proxy.com/https://github.com/folke/which-key.nvim",
		event = "VeryLazy",
	...
	-- 滚动条
	{
		"https://gh-proxy.com/https://github.com/petertriho/nvim-scrollbar",
		opts = {
			handelers = {
	...
	{
		"https://gh-proxy.com/https://github.com/kosayoda/nvim-lightbulb",
	},

	-- -- TODO:configrure later when having an LSP with code actions
	{
		"https://gh-proxy.com/https://github.com/rachartier/tiny-code-action.nvim",
		dependencies = {
