-- 代码补全引擎（如coc.vim、mini.complition、nvim-cmp、blink.cmp）
return {
  {
    "https://gh-proxy.com/https://github.com/saghen/blink.cmp",
    -- optional: provides snippets for the snippet source
    dependencies = {
      -- 'https://gh-proxy.com/https://github.com/rafamadriz/friendly-snippets'
      "nvim-tree/nvim-web-devicons",
      "https://gh-proxy.com/https://github.com/onsails/lspkind.nvim",
      "https://gh-proxy.com/https://github.com/fang2hou/blink-copilot",
      "folke/lazydev.nvim",
    },
